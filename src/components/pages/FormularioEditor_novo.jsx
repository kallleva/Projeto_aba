    ...
    <div className="w-full max-w-6xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="card-spacing">
        <form onSubmit={(e) => { e.preventDefault(); handleSave(); }} className="space-y-8">
          ...
          <div className="border-b pb-6" style={{borderBottomColor: 'var(--color-neutral-200)'}}>
          ...
          <div>
            ...
            {formData.perguntas.length === 0 ? (
              ...
              <div className="overflow-x-auto border" style={{borderColor: 'var(--color-neutral-200)', borderRadius: '6px'}}>
                <table className="table">
                  ...
                  <tbody>
                    {formData.perguntas
                      ...
                      .map((p, index) => (
                        <tr key={p.id}>
                          <td className="font-medium text-center">{p.ordem}</td>
                          <td>
                            <Input
                              value={p.texto}
                              onChange={(e) => {
