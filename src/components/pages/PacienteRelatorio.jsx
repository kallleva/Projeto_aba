...
export default function PacienteRelatorio({ paciente, relatorioPaciente, agendamentos, loadingRelatorio, formatDate, calcularIdade }) {
  ...
  }, [chartType, datasSelecionadas, relatorioPaciente]);
          ...
          {relatorioPaciente && (
            <div className="card-spacing animate-fade-in" style={{ animationDelay: '0.1s' }}>
              <div className="section-header">
                ...
                <h2 className="section-header-title">Radar de Percentuais/Fórmulas</h2>
              </div>
              <p className="card-text mb-4">Cada eixo representa um índice calculado. Compare até 3 sessões (datas).</p>
